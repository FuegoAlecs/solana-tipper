...
const AccountActions = ({ openAuthModal }) => {
  return (
    <div className="text-center">
      <button
        onClick={openAuthModal}
        className="inline-flex items-center bg-white text-indigo-600 font-medium py-2 px-4 rounded-full border border-indigo-200 cursor-pointer transition-all duration-200 ease-in-out hover:bg-indigo-100 hover:text-indigo-700"
      >
