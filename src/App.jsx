...
function App() {
  ...
  const { isAuthenticating, isConnected } = useSignerStatus();
  const {
    sendTransaction,
    isPending,
    signer,
    ...
    const fetchSolPrice = async () => {
      try {
        const response = await fetch(
          `https://api.alchemy.com/v1/prices?token=SOL&apiKey=${
  ...
  useEffect(() => {
    if (txHash) {
      setTipStatus(`Success! Transaction ID: ${txHash.substring(0, 10)}...`);
          ...
          >
            ...
            <button
              ...
              style={{
                ...
                cursor:
                  isPending || !recipientAddress || !isValidAddress
                    ? "not-allowed"
                    : "pointer",
                backgroundColor:
                  isPending || !recipientAddress || !isValidAddress
            ...
            {tipStatus && (
              <div
                style={{
                  ...
                  textAlign: "center",
                  fontWeight: "500",
                  backgroundColor: tipStatus.includes("Success")
                    ? "#F0FDF4"
                    : "#FEF2F2",
                  color: tipStatus.includes("Success") ? "#166534" : "#B91C1C",
                  border: `1px solid ${
                    tipStatus.includes("Success") ? "#BBF7D0" : "#FECACA"
                  }`,
                }}
              >
                <div
